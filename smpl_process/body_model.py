...
from smpl_process.lbs import lbs
...
class BodyModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.register_buffer('v_template', torch.tensor(v_template, dtype=dtype)) # v_template (1, 6890, 3)
        ...
        print (smpl_dict['shapedirs'].shape) # (6890, 3, 10)
        ...
        kintree_table = smpl_dict['kintree_table'].astype(np.int32) # (2, 24)
        ...
        weights = smpl_dict['weights'] # (6890, 24)
        ...
        self.register_parameter('trans', nn.Parameter(trans, requires_grad=True)) # (1, 3)
        ...
        self.register_parameter('betas', nn.Parameter(betas, requires_grad=True)) # (1, 10)
